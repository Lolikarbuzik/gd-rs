...
pub const GD_LEVEL_KEY_FORMAT: [[&str; 2]; 77] = [
    ["k1", "levelid"],
    ["k2", "levelname"],
    ["k3", "description"],
    ["k4", "innerlevelstring"],
    ...
    ["k17", "gameversion"],
    ["k18", "attempts"],
    ["k19", "normalmodepercentage"],
    ["k20", "practicemodepercentage"],
    ["k21", "leveltype"],
    ["k22", "likerating"],
    ["k23", "length"],
    ["k24", "dislikes"],
    ...
    ["k81", "secondsspentediting"],
    ["k82", "islevelfavourited"],
    ["k83", "levelorder"],
    ["k84", "levelfolder"],
    ["k85", "clicks"],
    ["k86", "playertime"],
...
pub const GD_PROPS_MAP: [(&str, &str); 743] = [
    ("1", "id"),
    ("2", "x"),
    ("3", "y"),
    ("4", "flip_horiz"),
